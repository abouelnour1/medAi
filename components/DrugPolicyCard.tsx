...
const DrugPolicyCard: React.FC<DrugPolicyCardProps> = ({ group, t, onSelectInsuranceData }) => {
    ...
    return (
        <div className="bg-green-50/30 dark:bg-green-900/10 rounded-2xl shadow-sm p-4 animate-fade-in border-2 border-green-200 dark:border-green-800 space-y-3">
             <div className="border-b pb-3 border-green-100 dark:border-green-800/50">
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-grow">
                        <h2 className="text-base font-black text-green-800 dark:text-green-300 leading-tight mb-1 break-words">
