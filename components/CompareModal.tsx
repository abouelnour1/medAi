...
const CompareModal: React.FC<CompareModalProps> = ({ medicines, onClose, language }) => {
  ...
  return (
    <div className="fixed inset-0 z-[150] bg-black/60 backdrop-blur-sm flex items-end justify-center" style={{padding: "1rem 1rem calc(7.5rem + env(safe-area-inset-bottom))"}} onClick={onClose}>
