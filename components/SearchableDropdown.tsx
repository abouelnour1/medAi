...
const SearchableDropdown: React.FC<SearchableDropdownProps> = ({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute z-[70] w-full mt-2 bg-white dark:bg-dark-card rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 max-h-[350px] flex flex-col overflow-hidden animate-zoom-in">
