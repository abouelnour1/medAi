...
const ClinicalDataPage: React.FC<Props> = ({ registerNumber, tradeName, scientificName, language, isAdmin, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[80] bg-light-bg dark:bg-dark-bg flex flex-col animate-slide-up">
      {/* Header */}
      <div className="flex items-center gap-3 px-4 pt-safe-top pb-4 pt-4 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-dark-card flex-shrink-0">
