...
export type View = 'search' | 'addData' | 'details' | 'results' | 'alternatives' | 'settings' | 'chatHistory' | 'insuranceSearch' | 'addInsuranceData' | 'prescriptions' | 'prescription' | 'insuranceDetails' | 'login' | 'register' | 'admin' | 'favorites' | 'verifyEmail' | 'aiHistory' | 'notifications' | 'imageView' | 'generalSettings' | 'orderList' | 'stockTracker' | 'indicationSearch' | 'pedDoseHistory' | 'recentlyViewed';
