...
export const translations = {
  ar: {
    ...
    searchBy: 'بحث حسب',
    addCosmeticsData: 'بيانات مستحضرات التجميل',
    addCosmeticsDataTitle: 'إضافة بيانات مستحضرات التجميل',
    addCosmeticsDataDescription: 'أضف بيانات مستحضرات التجميل بتنسيق JSON.',
    cosmeticsSearchTitle: 'بحث مستحضرات التجميل',
